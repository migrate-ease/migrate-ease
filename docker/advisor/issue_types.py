...
#  ===
#   'ImageIssue'                : <class 'advisor.image_issue.ImageIssue'>
#   'PluginIssue'               : <class 'advisor.plugin_issue.PluginIssue'>
#   'ConfigurationInfoIssue'    : <class 'advisor.configuration_info_issue.ConfigurationInfoIssue'>
