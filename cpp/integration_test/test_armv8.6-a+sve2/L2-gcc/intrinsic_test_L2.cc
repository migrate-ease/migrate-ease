// shall not generate issue in armv8.6-a+sve2
...
// shall not generate issue in armv8.6-a+sve2 with gcc compiler
void gcc_intrinsic_test()
{
...
// shall generate issue in armv8.6-a+sve2
