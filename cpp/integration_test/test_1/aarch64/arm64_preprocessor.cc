/*
 * 1. Test non-aarch64 arch specific macros
 * 2. test #error preprocessor directive
 */
#if defined(__aarch64__)
#error "macro (__aarch64__) test PASSED!!" //expect: PreprocessorErrorIssue
#else
#error "macro (__aarch64__) test FAILED!!"
#endif

#if defined(arm64)
#error "macro (arm64) test PASSED!!"
#else
#error "macro (arm64) test FAILED!!"  //expect: PreprocessorErrorIssue
#endif
...
#if defined(arm)
#error "macro (arm) test PASSED!!"
#else
#error "macro (arm) test FAILED!!"  //expect: PreprocessorErrorIssue
#endif
...
#if defined(neon)
#error "macro (neon) test PASSED!!"
#else
#error "macro (neon) test FAILED!!" //expect: PreprocessorErrorIssue
#endif
...
#if defined(sve)
#error "macro (sve) test PASSED!!"
#else
#error "macro (sve) test FAILED!!"   //expect: PreprocessorErrorIssue
#endif
