// Set the warning level to L2, the tool will check branches in SUPPORTED and UNKOWN states.
// start of common test for clang.
...
#endif
#endif
// end of common test for clang.

// start of clang specific tests.
