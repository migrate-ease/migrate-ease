...
# Intrinsics available on 32-bit arm
ARM_INTRINSICS = content["COMMON_INTRINSICS"] + content["ARM_INTRINSICS"]

ARM_INCOMPATIBLE_INTRINSICS = init_checkpoints(
    content['X86_INTRINSICS'] +
    content['OTHER_ARCH_INTRINSICS'] +
    content['INCOMPATIBLE_UCRT_INTRINSICS'] +
    content['ARM_MSVC_INTRINSICS'] +
    content['AARCH64_GCC_INTRINSICS'] +
    content['AARCH64_NEON_INTRINSICS'] +
    content['AARCH64_MSVC_INTRINSICS'], ARM_INTRINSICS)

# Intrinsics available with gcc on aarch64.
AARCH64_GCC_INTRINSICS = content["COMMON_INTRINSICS"] + content["AARCH64_GCC_INTRINSICS"]

AARCH64_GCC_INCOMPATIBLE_INTRINSICS = init_checkpoints(
    content['X86_INTRINSICS'] +
    content['OTHER_ARCH_INTRINSICS'] +
    content['INCOMPATIBLE_UCRT_INTRINSICS'] +
    content["ARM_INTRINSICS"] +
    content['ARM_MSVC_INTRINSICS'] +
    content['AARCH64_MSVC_INTRINSICS'], AARCH64_GCC_INTRINSICS)

AARCH64_CLANG_INTRINSICS = content["COMMON_INTRINSICS"]

AARCH64_CLANG_INCOMPATIBLE_INTRINSICS = init_checkpoints(
    content['X86_INTRINSICS'] +
    content['OTHER_ARCH_INTRINSICS'] +
    content['INCOMPATIBLE_UCRT_INTRINSICS'] +
    content["ARM_INTRINSICS"] +
    content['ARM_MSVC_INTRINSICS'] +
    content['AARCH64_MSVC_INTRINSICS'] +
    content['AARCH64_GCC_INTRINSICS'], AARCH64_CLANG_INTRINSICS)

# armv8.6-a+sve
N2_GCC_INTRINSICS = AARCH64_GCC_INTRINSICS + content['AARCH64_SVE_INTRINSICS']

N2_GCC_INCOMPATIBLE_INTRINSICS = AARCH64_GCC_INCOMPATIBLE_INTRINSICS

N2_CLANG_INTRINSICS = content["COMMON_INTRINSICS"] +content['AARCH64_SVE_INTRINSICS']

N2_CLANG_INCOMPATIBLE_INTRINSICS = AARCH64_CLANG_INCOMPATIBLE_INTRINSICS
...
X86_INCOMPATIBLE_INTRINSICS = init_checkpoints(
    ...
    content['AARCH64_MSVC_INTRINSICS'] +
    content['AARCH64_GCC_INTRINSICS'] +
    content['AARCH64_NEON_INTRINSICS'], X86_INTRINSICS)
